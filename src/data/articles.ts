...
import novaHeaderImage from '@/context/TOu5LuVnvE.png'
import novaInlineImage from '@/context/xGO8iOWws7.png'
...

  {
    ...
    body: [
      ...
      'Tenev will serve as the central figure throughout the documentary, with the film following both Robinhood’s history and its future ambitions through his perspective.',
      {
        ...
        caption: 'Promotional artwork for “The Great Start – Robinhood,” coming to BBC Movies.',
        alt: 'The Great Start Robinhood documentary promotional poster featuring Vlad Tenev',
      },
      ...
      'More details are available at https://bbc-movie.com/',
      {
        type: 'heading',
      ...
      'For now, the first promotional material carries a simple message:',
    ],
    category: 'Tech',
    time: '19:35',
    section: 'tech',
